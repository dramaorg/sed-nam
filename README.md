...
[![Build Status](https://github.com/dramaorg/sed-nam/workflows/CI/badge.svg?branch=main)](https://github.com/dramaorg/sed-nam/actions)
[![Tested on APIs.guru](https://api.apis.guru/badges/tested_on.svg)](https://apis.guru/browse-apis/)

[![npm](https://img.shields.io/npm/v/@dramaorg/sed-nam.svg)](https://www.npmjs.com/package/@dramaorg/sed-nam)
[![License](https://img.shields.io/npm/l/@dramaorg/sed-nam.svg)](LICENSE)

[![OS and Browser Compatibility](https://apitools.dev/img/badges/ci-badges-with-ie.svg)](https://github.com/dramaorg/sed-nam/actions)
...
- **[Tested](https://github.com/dramaorg/sed-nam/actions)** in Node.js and all modern web browsers on Mac, Windows, and Linux
...
To reduce the amount of potentially unnecessary noise that these JSON pointer errors provide, `@dramaorg/sed-nam` utilizes [better-ajv-errors](https://www.npmjs.com/package/@readme/better-ajv-errors), along with some intelligent reduction logic, to only surface the errors that _actually_ matter.
